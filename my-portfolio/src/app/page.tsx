...
export default function Home() {
  ...
  return (
    <main
      className="flex min-h-screen flex-col items-center justify-center p-8 text-center pt-20 bg-cover bg-center"
      style={{ backgroundImage: 'url("/backgrounds/home_background3.jpg")' }} // Also fixed missing closing quote and parenthesis here
    >
